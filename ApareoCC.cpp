...
//Apareo:Dadas la lista del primer parcial y la del segundo parcial mostrar situaci�n
...
void apareo(Nodo*lista1, Nodo*lista2)
{
    ...
    while(r1!=NULL && r2!=NULL)
    {
        ...
        {
            cout<<r1->info.leg<<condicion(r1->info.nota,0)<<endl; //En este caso, que sea menor quiere decir que el alumno de la segunda lista no rindió el primer parcial, entonc
            r1=r1->sig;
        }
        else
        {
